...
<pre><code class="language-java">name: Update Blog Posts
...
<p>1) velog 리포지토리 -&gt; Add file -&gt; Create new file</p>
<ul>
<li>파일 경로 : <code>scripts/update_blog.py</code></li>
<li><code>update_blog.py</code> 파일 작성</li>
</ul>
<pre><code class="language-java">import feedparser
import git
import os
...
<li><p>Name : GH_PAT, Secret : [2번에서 발급받은 토큰]</p>
</li>
</ol>